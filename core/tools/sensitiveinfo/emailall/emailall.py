...
class EmailAll(object):
    ...
    def main(self):
        ...
        if not self.access_internet:
            ...
            logger.log('ALERT', 'Exit please check network to http://ip-api.com/json/')
        elif self.access_internet:
    ...
    def run(self):
        ...
        self.access_internet, self.in_china = True, True
